...
export default {
    ...
    triggerEvents: [
        ...
        },
        {
            ...
            event: { prompt: '', modificationType: '', action: '', selectedText: '', htmlValue: '', timestamp: '' },
        },
        {
    ...
    properties: {
        ...
        timelineContainerSelector: {
            section: 'settings',
            label: { en: 'Timeline container (CSS selector)', fr: 'Conteneur de la frise (sélecteur CSS)' },
            type: 'Text',
            defaultValue: '',
            bindable: true,
            hidden: content => !content.enableCollaboration,
        ...
        maxConnectionAttempts: {
            section: 'settings',
            label: { en: 'Max Connection Attempts', fr: 'Tentatives de connexion max' },
            type: 'Number',
            options: {
                min: 1,
                max: 20,
