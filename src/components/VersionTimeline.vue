...
export default {
    ...
    mounted() {
        ...
        // Remontage à chaud (conteneur externe résolu après coup) : les props
        // n'ont pas bougé depuis le montage, donc aucun watcher ne recentre —
        // se caler immédiatement sur la sélection, sans animation
